...
class DataSeries(models.Model):
    ...
    metric = models.ForeignKey(
        Metric, related_name='series', verbose_name='Метрика', on_delete=models.PROTECT
    )
    ...
    registrator = models.CharField(
        max_length=250, verbose_name='Регистратор', blank=True
    )
    date = models.DateField(default=datetime.now,
                            blank=True, verbose_name='Дата')
