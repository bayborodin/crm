...
def index(request):
    ...
    if orders_cnt_prev_week == 0:
        ...
        orders_cnt_percent = round((orders_cnt_cur_week - orders_cnt_prev_week) / orders_cnt_prev_week * 100)

    if orders_sum_prev_week == 0:
        orders_sum_percent = '__'
    else:
        orders_sum_percent = round((orders_sum_cur_week - orders_sum_prev_week) / orders_sum_prev_week * 100)
