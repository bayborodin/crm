    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kpp', models.CharField(db_index=True, max_length=9, verbose_name='КПП')),
                ('code_1c', models.CharField(db_index=True, max_length=12, verbose_name='Код в 1С')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='legal_entities', to='accounts.Account', verbose_name='Контрагент')),
            ],
            options={
