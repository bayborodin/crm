...
class Lead(models.Model):
    ...
    company_name = models.CharField(
        max_length=250, verbose_name='Компания', blank=True,
    )
    ...
    comment = models.CharField(
        max_length=250, verbose_name='Комментарий', blank=True,
    )
    first_person = models.CharField(
        max_length=250, verbose_name='ЛПР', blank=True,
    )
    first_person_position = models.CharField(
        max_length=250, verbose_name='Должность', blank=True,
    )
    bank_account = models.CharField(
        max_length=250, verbose_name='Р/С', blank=True,
    )
    bank_name = models.CharField(
        max_length=250, verbose_name='Банк', blank=True,
    )
    bank_rcbic = models.CharField(
        max_length=250, verbose_name='БИК', blank=True,
    )
    ...
    delete_mark = models.BooleanField(
        verbose_name='Пометка на удаление', default=False,
    )
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
